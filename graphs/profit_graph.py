...
def get_evaluation(solution, 
                   ...
                   verbose=1):
    global profit_list, timesteps_list
    ...
    for seed in seeds:
        ...
        profit_list[-1].append(profit_list[-2] + profit_list[-1])

    # return OBJECTIVE, lifespan_list, timesteps_list
    return OBJECTIVE

def getProfitList():
    print('profit length', len(profit_list))
    return profit_list

def getTimestepsList():
    print('timestep length', len(timesteps_list))
