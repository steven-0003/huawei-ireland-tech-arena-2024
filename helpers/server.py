...
class Server(object):
    def __init__(self, id, deployed_timestep,name,release_time, purchase_price, slots_size, energy_consumption, capacity, life_expectency,
                 cost_of_moving, avg_maintenance_fee, latency_sensitivity, selling_price):
        self.name = name
        self.id = id
        self.deployed_timestep = deployed_timestep
        self.name = name
